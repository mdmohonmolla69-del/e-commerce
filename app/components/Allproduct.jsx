...
const Allproduct = () => {
    ...
    return (
        <div>
            ...
            <div className='mt-5'>
                <Link href="/allproductlist"><h2 className='select-none text-start text-2xl font-bold text-black flex items-center '><span className="material-symbols-outlined">
                    storefront
                </span>All Product</h2></Link>
